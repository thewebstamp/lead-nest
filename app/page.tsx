          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
              {[
                ...
                <div key={index} className="text-center p-6 rounded-xl border border-gray-300 bg-linear-to-br from-white to-gray-50/80 shadow-md hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300">
